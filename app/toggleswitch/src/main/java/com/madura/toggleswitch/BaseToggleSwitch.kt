...
abstract class BaseToggleSwitch : LinearLayout, ToggleSwitchButton.Listener {
    ...
    constructor(context: Context) : super(context) {
        ...
        borderRadius                =
            dp2px(context, BORDER_RADIUS_DP.toFloat())
        borderWidth                 =
            dp2px(context, BORDER_WIDTH.toFloat())
            ...
            try {
                ...
                if (entries == null || entries.isEmpty()) {
                    ...
                    if (!TextUtils.isEmpty(textToggleLeft) && !TextUtils.isEmpty(textToggleRight)) {
                        textToggleLeft?.let { entriesList.add(it) }
                        ...
                        if (!TextUtils.isEmpty(textToggleCenter)) {
                            textToggleCenter?.let { entriesList.add(it) }
                        }
                        textToggleRight?.let { entriesList.add(it) }
